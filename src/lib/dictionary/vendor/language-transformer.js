...
/*
 * Vendored into Mokuro Reader (2026) from Yomitan
 * (https://github.com/yomidevs/yomitan), ext/js/language/language-transformer.js.
 * Modified: added `// @ts-nocheck`, and replaced `import {log} from
 * '../core/log.js'` with the minimal console.warn stub below to drop the
 * dependency. Logic unchanged.
 */

const log = { warn: (e) => console.warn(e) };
