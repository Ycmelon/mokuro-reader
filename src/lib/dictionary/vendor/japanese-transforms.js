 ...
 * (https://github.com/yomidevs/yomitan), ext/js/language/ja/japanese-transforms.js.
 * Modified: added `// @ts-nocheck`, and changed the import path from
 * '../language-transforms.js' to the sibling './language-transforms.js'.
 * Ruleset unchanged.
 */
